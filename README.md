...
- 🗂️ **5개 탭** — 파라미터 편집 / 파라미터 값 수정(PI▸Recipe▸Zone▸Alg▸파라미터 드릴다운 트리) / 호기 비교·누락 / 변경 이력 / 특이사항
- 📐 **스프레드시트형 UX(tksheet)** — 셀 테두리·자동 줄바꿈·행높이·**Parameter 열까지 열 고정**(횡스크롤해도 보임)
