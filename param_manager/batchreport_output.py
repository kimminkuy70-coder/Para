...
METRIC_NAME = {
    ...
    "M08": "Recipe별 정상 Dice 통계", "M09": "품질 이상 후보",
...
INTERPRET = {
    ...
    "M06": [("teal", "읽는 법", "'유형별 재시작 간격' 표의 맨 아래 '(전체 유효)' 행이 전체 재시작 간격의 대표값(복구 baseline)입니다. 별도 지표(구 M07)로 두지 않고 여기에 합쳤습니다."),
            ("rust", "한계", "간격은 리포트 간 시각차 기반 proxy로 실제 수리시간이 아닙니다. 0~1440분만 집계에 포함합니다.")],
