...
pub fn desktop_send(request: Value, state: tauri::State<'_, Desktop>) -> Result<(), String> {
    const METHODS: [&str; 14] = ["contract", "configuration", "investigate", "analyze", "table_page", "cancel", "release", "shutdown", "recipe_open", "recipe_page", "recipe_edit", "document_open", "document_page", "document_edit"];
